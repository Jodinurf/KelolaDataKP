...
namespace KelolaDataKP
{
    internal class vPRMTKP
    {
        ...
        public void baca(SqlConnection con)
        {
            ...
            while (r.Read())
            {
                Console.WriteLine($"KD Surat KP: {r["KD_SrtKP"]}, NIM: {r["nim"]}, Kode Perusahaan: {r["kd_Perusahaan"]}, Nama Penerima: {r["NamaPenerima"]}, Tugas: {r["Tugas"]}, File DOC: {r["fileDOC"]}");
                Console.WriteLine();
            }
            r.Close();
        }
        ...
        public void searchByKdSrtKP(string kdSrtKP, SqlConnection con)
        {
            ...
            if (reader.HasRows)
            {
                ...
                while (reader.Read())
                {
                    Console.WriteLine($"KD Surat KP: {reader["KD_SrtKP"]}, NIM: {reader["nim"]}, Kode Perusahaan: {reader["kd_Perusahaan"]}, Nama Penerima: {reader["NamaPenerima"]}, Tugas: {reader["Tugas"]}, File DOC: {reader["fileDOC"]}");
                }
            }
            else
            {
