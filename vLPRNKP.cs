...
namespace KelolaDataKP
{
    internal class vLPRNKP
    {
        ...
        public void baca(SqlConnection con)
        {
            ...
            while (r.Read())
            {
                Console.WriteLine($"ID Laporan: {r["ID_Laporan"]}, NIM: {r["nim"]}, NIK Dosen: {r["NIK"]}, Tanggal: {r["Tanggal"]}, File DOC: {r["fileDOC"]}");
                Console.WriteLine();
            }
            r.Close();
        }
        ...
        public void searchByIdLaporan(string idLaporan, SqlConnection con)
        {
            ...
            if (reader.HasRows)
            {
                ...
                while (reader.Read())
                {
                    Console.WriteLine($"ID Laporan: {reader["ID_Laporan"]}, NIM: {reader["nim"]}, NIK Dosen: {reader["NIK"]}, Tanggal: {reader["Tanggal"]}, File DOC: {reader["fileDOC"]}");
                }
            }
            else
            {
